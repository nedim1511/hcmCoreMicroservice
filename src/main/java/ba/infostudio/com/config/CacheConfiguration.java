...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("hcmCoreMicroservice");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("hcmCoreMicroservice");
        ...
        config.getMapConfigs().put("ba.infostudio.com.domain.*", initializeDomainMapConfig(jHipsterProperties));
